  ...
  static getTitleData(double maxY, double minY, int maxX, int minX) =>  FlTitlesData(
        leftTitles: SideTitles(
            ...
            getTitles: (val) {
              ...
              double increase = diff/4;
              /*
              print("increse " + increase.toString());
              print("diff " + diff.toString());
              print("max"+ maxY.toString());
              print("min"+ minY.toString());
              print((minY+(1.5*increase)).toString());
              print((minY+(2.5*increase)).toString());
              print((minY+(3.5*increase)).toString());
              */
              /*
              if(val==minY){
                print("ilk değer"+(minY+(0.5*increase)).toString());
                return minY.toString();
              }else if(val>(minY+(1.0*increase)) && val<(minY+(2.0*increase))){
                print("ikinci değer"+(minY+(1.5*increase)).toString());
                return (minY+(1.5*increase)).toString();
              }else if(val>(minY+(2*increase)) && val<(minY+(3*increase))){
                print("üç değer"+(minY+(2.5*increase)).toString());
                return (minY+(2.5*increase)).toString();
              }
              else if(val>(minY+(3*increase)) && val<(minY+(4*increase))){
                    print("üç değer"+(minY+(2.5*increase)).toString());
                    return (minY+(3.5*increase)).toString();
              }else{
                return "";
              }
              */
        ...
        bottomTitles: SideTitles(
          ...
          reservedSize: 38,
          getTitles: (val) {
            int diffTime = maxX- minX;
            int increase = ((diffTime/4).toString()).toInt();
            /*
            switch (val.toInt()) {
              case 1:
                print(minX.toString());
              ...
              case 2:
                print((minX+((val.toInt()-1)*increase)).toString());
                return (minX+((val.toInt()-1)*increase)).toString();
              case 3:
                print((minX+((val.toInt()-1)*increase)).toString());
                return (minX+((val.toInt()-1)*increase)).toString();
              case 4:
